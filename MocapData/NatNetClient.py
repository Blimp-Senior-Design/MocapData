...
import copy
import time
import MocapData.DataDescriptions as DataDescriptions
import MocapData.MoCapData as MoCapData
...
# Unpack Mocap Data Functions
    ...
    def run(self):
        ...
        self.command_thread = Thread(target=self.__command_thread_function, args=(
            self.command_socket, lambda: self.stop_threads, lambda: self.print_level,))
